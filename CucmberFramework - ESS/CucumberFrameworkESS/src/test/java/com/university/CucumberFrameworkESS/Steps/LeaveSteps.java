package com.university.CucumberFrameworkESS.Steps;
...
public class LeaveSteps {
	...
	@Before()
	public void setup() {
	//	System.setProperty("webdriver.chrome.driver", "D:\\chromedriver_win32\\chromedriver.exe"); - uncomment it once start using 
	...
	//driver.get("http://burjsrv-qa/ESS/login/customlogin.aspx?"); - uncomment it once start using 
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	 ...
	 @Given("^User selects \"([^\"]*)\"$")
	 public void user_selects(int leave_type) throws Throwable {
	     // Write code here that turns the phrase above into concrete actions
		 Select dropdown = new Select(driver.findElement(By.id("ctl00_cphRootContent_ucLeaveRequestSetup_CLT_Leave_ID")));
		 dropdown.selectByIndex(leave_type);
		 Thread.sleep(1000);
	 }

	 @Given("^User enters \"([^\"]*)\"$")
	 public void user_enters(String number_of_days) throws Throwable {
	 ...
	 @Given("^User enters  \"([^\"]*)\" , \"([^\"]*)\" , \"([^\"]*)\"$")
	 public void user_enters(String day, String month, String year) throws Throwable {
	    
		 driver.findElement(By.id("ctl00_cphRootContent_ucLeaveRequestSetup_Leave_Start_Date")).click();
		 Thread.sleep(2000);
		  driver.findElement(By.id("ctl00_cphRootContent_ucLeaveRequestSetup_Leave_Start_Date")).sendKeys(day); 
		  driver.findElement(By.id("ctl00_cphRootContent_ucLeaveRequestSetup_Leave_Start_Date")).sendKeys(month); 
		  driver.findElement(By.id("ctl00_cphRootContent_ucLeaveRequestSetup_Leave_Start_Date")).sendKeys(year); 
	 ...
	 public void record_is_submitted() throws Throwable {
		 String msg = driver.findElement(By.id("ctl00_cphRootContent_ucLeaveRequestSetup_Message")).getText(); 
		 System.out.println("Leave Submitted: " + msg );
